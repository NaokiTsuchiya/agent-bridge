 ...
 */
final class CliRoundTripTest extends TestCase
{
    ...
    public function handsTheMessageOverUnchanged(): void
    {
        ...
        self::assertStringContainsString('"text":"what is the weather"', $this->handedOver());
    }
    ...
    /**
     * @return string every line of input the agent that answered was handed, joined
     */
    private function handedOver(): string
    {
        ...
        // yet is started twice, and only the second of those is ever given anything to read.
