...
final class SlackApiEndpointTest extends TestCase
{
    ...
    {
        $this->host = getenv(SlackApiEndpoint::HOST_VARIABLE);
        $this->port = getenv(SlackApiEndpoint::PORT_VARIABLE);
    }
    ...
    {
        self::restore(SlackApiEndpoint::HOST_VARIABLE, $this->host);
        self::restore(SlackApiEndpoint::PORT_VARIABLE, $this->port);
    }
    ...
    {
        putenv(SlackApiEndpoint::PORT_VARIABLE . "={$value}");

        self::assertSame($port, SlackApiEndpoint::fromEnvironment()->port);
    }
    ...
    public function keepsAHostThatIsNothingButWhitespace(): void
    {
        ...
        self::assertSame('   ', SlackApiEndpoint::fromEnvironment()->host);
    }
    ...
    public function refusesAValueThatIsNotAPort(string $value): void
    {
        ...
        try {
            SlackApiEndpoint::fromEnvironment();
